...
宜小的意思也不是越小越好，用一个团队去解决一个太小的问题的话，也是 “大材小用” ，是对于有限的时间精力的浪费。那到底多大的课题才适合QC小组活动呢？具体可以参考如下的表格，选择其中的中问题开展QC小组活动。
...
#### 3.1.2  评价指标应具体化、数据化，并具有可比性

选择需要解决的课题应是能弄清现状、且能以特性值明确的，特征值应该能用具体的数据表示，以便于制定明确的目标，有的放矢第进行改进和提高。
...
对于任一个企业和项目来说，所存在的问题和需要改进的课题都是非常多的，所以在课题的选择过程中，要发动和调动职工的积极性，大家共同探讨，以选择合适的课题，解决实际的问题。

课题选择一般采用表决法和评议评价法，推荐使用评议评价法。

所谓的评议评价，即把小组各成员提出的课题进行汇总，然后从重要性、迫切性、经济性、预期效果和可实施性等方面，进行评议评价和打分，并根据综合得分选定本次的QC小组活动课题。  
