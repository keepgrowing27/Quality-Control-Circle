...
### 3.1 QC课题选择要点
#### 3.1.1  选题宜小不宜大
所选择的课题，其活动时间以 3-6 个月为宜，最长不要超过一年。项目的QC小组活动，一般一个经营年度安排两期，即上期和下期，一个的时间约6个月。由于2019年上半年没有督促各项目开展QC小组活动，故为了不影响年底QC小组课题对集团公司的上报工作，本次课题的选择以在12月中旬前完成结题为宜。
...
但也不能一味求小，用一个团队去解决一个太小的问题的话，也是 “大材小用” 。
那到底多大的课题才适合QC小组活动呢？具体可以参考如下的表格:
** 公司/项目中问题点类型及建议的解决方法**
| 问题描述 | 解决方法 | 问题大小|
|---------      |---------     |---------      |
